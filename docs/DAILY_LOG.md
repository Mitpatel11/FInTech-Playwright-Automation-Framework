...
Goal: Run the Cypress Real world app and install the playwright and structure it. 
Completed : init playwright , created basic folder structure with proper plan and the full steup is done like .env set , .gitignore , confugured the config.ts file. 
